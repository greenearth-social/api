"""Tests for the LLM query vector cache and candidate generator."""
...
KNN_SEARCH_POSTS = "app.lib.candidates.llm_query_vector_cache.knn_search_posts"
...
def _mock_cache(latest_return=None) -> MagicMock:
    """Return a mock LlmQueryVectorCache with get_latest pre-configured."""
    cache = MagicMock()
