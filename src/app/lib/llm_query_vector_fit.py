...
import certifi  # transitive via requests/httpx; adding it to Pipfile relocks 20 packages
import numpy as np
...
def _get_anthropic_client() -> AsyncAnthropic:
    ...
    if _client is None:
        ...
        # ~80 scoring calls opening connections at once this corrupted the
        # heap on Cloud Run (SIGABRT, "realloc(): invalid next size"; stage,
        # 2026-09-06). A plain stdlib context with certifi's bundle avoids it.
